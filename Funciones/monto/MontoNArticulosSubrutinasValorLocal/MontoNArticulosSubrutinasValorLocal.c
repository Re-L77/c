...
#include "stdlib.h"
/*
 * Programa que calcula el monto de n artículos con uso de subrutinas y valores
 * locales:. Autor: Ordaz Magos Juan Pablo Fecha: 25-02-25 Versión: 3.0
 */
...
void mostrarMonto(float monto) { printf("Monto total: %.2f\n", monto); }
